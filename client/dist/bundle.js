...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Task: () => (/* binding */ Task)\n/* harmony export */ });\n/* harmony import */ var _enums_TaskStatuses_enum__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../enums/TaskStatuses.enum */ \"./build/enums/TaskStatuses.enum.js\");\n\nvar Task = /** @class */function () {\n  function Task(id, config) {\n    var _this = this;\n    this.getID = function () {\n      return _this.id;\n    };\n    this.getStatus = function () {\n      return _this.status;\n    };\n    this.getOriginData = function () {\n      return _this.originData;\n    };\n    this.getEventName = function () {\n      return _this.eventName;\n    };\n    this.getResponse = function () {\n      return _this.responseData;\n    };\n    this.getOnError = function () {\n      return _this.onError;\n    };\n    this.getOnSuccess = function () {\n      return _this.onSuccess;\n    };\n    this.setID = function (id) {\n      _this.id = id;\n    };\n    this.setStatus = function (isResolved) {\n      _this.status = isResolved;\n    };\n    this.setOriginData = function (originData) {\n      _this.originData = originData;\n    };\n    this.setEventName = function (eventName) {\n      _this.eventName = eventName;\n    };\n    this.setResponse = function (response) {\n      _this.responseData = response;\n    };\n    this.setOnError = function (onError) {\n      _this.onError = onError;\n    };\n    this.setOnSucces = function (onSucces) {\n      _this.onSuccess = onSucces;\n    };\n    this.toJSONString = function () {\n      var json = {\n        taskID: _this.id.toString(),\n        commandName: _this.eventName,\n        status: _this.status,\n        data: JSON.stringify(_this.originData)\n      };\n      console.log(\"toSend\", JSON.stringify(json));\n      return JSON.stringify(json);\n    };\n    this.id = id;\n    this.originData = config.data;\n    this.onError = config.onError;\n    this.onSuccess = config.onSuccess;\n    this.eventName = config.eventName;\n    this.responseData = null;\n    this.status = _enums_TaskStatuses_enum__WEBPACK_IMPORTED_MODULE_0__.TaskStatuses.Unexecuted;\n  }\n  return Task;\n}();\n\n\n//# sourceURL=webpack://zonk/./build/tasks/Task.js?");

/***/ }),

/***/ "./build/tasks/tasks.controller.js":
/*!*****************************************!*\
  !*** ./build/tasks/tasks.controller.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   TasksController: () => (/* binding */ TasksController)\n/* harmony export */ });\n/* harmony import */ var _app_service_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../app.service.js */ \"./build/app.service.js\");\n/* harmony import */ var _enums_events_enum_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../enums/events.enum.js */ \"./build/enums/events.enum.js\");\n\n\nvar TasksController = /** @class */function () {\n  function TasksController(tasksService) {\n    var _this = this;\n    this.tasksService = tasksService;\n    _app_service_js__WEBPACK_IMPORTED_MODULE_0__.AppService.on(_enums_events_enum_js__WEBPACK_IMPORTED_MODULE_1__.Events.GetTask, function (config) {\n      _this.tasksService.getTask(config);\n    });\n    _app_service_js__WEBPACK_IMPORTED_MODULE_0__.AppService.on(_enums_events_enum_js__WEBPACK_IMPORTED_MODULE_1__.Events.FetchTask, function (data) {\n      _this.tasksService.fetchTask(data);\n    });\n  }\n  return TasksController;\n}();\n\n\n//# sourceURL=webpack://zonk/./build/tasks/tasks.controller.js?");

/***/ }),

/***/ "./build/tasks/tasks.module.js":
/*!*************************************!*\
  !*** ./build/tasks/tasks.module.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   TasksModule: () => (/* binding */ TasksModule)\n/* harmony export */ });\n/* harmony import */ var _tasks_controller_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tasks.controller.js */ \"./build/tasks/tasks.controller.js\");\n/* harmony import */ var _tasks_service_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tasks.service.js */ \"./build/tasks/tasks.service.js\");\n\n\nvar TasksModule = /** @class */function () {\n  function TasksModule() {\n    var tasksService = new _tasks_service_js__WEBPACK_IMPORTED_MODULE_1__.TasksService();\n    new _tasks_controller_js__WEBPACK_IMPORTED_MODULE_0__.TasksController(tasksService);\n  }\n  return TasksModule;\n}();\n\n\n//# sourceURL=webpack://zonk/./build/tasks/tasks.module.js?");

/***/ }),

/***/ "./build/tasks/tasks.service.js":
/*!**************************************!*\
  !*** ./build/tasks/tasks.service.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   TasksService: () => (/* binding */ TasksService)\n/* harmony export */ });\n/* harmony import */ var _app_service_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../app.service.js */ \"./build/app.service.js\");\n/* harmony import */ var _enums_TaskStatuses_enum_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../enums/TaskStatuses.enum.js */ \"./build/enums/TaskStatuses.enum.js\");\n/* harmony import */ var _enums_events_enum_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../enums/events.enum.js */ \"./build/enums/events.enum.js\");\n/* harmony import */ var _Task_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Task.js */ \"./build/tasks/Task.js\");\n\n\n\n\nvar TasksService = /** @class */function () {\n  function TasksService() {\n    var _this = this;\n    this.taskPool = [];\n    this.getTask = function (config) {\n      console.log(\"cfg\", config);\n      var task = _this.createTask(config);\n      _app_service_js__WEBPACK_IMPORTED_MODULE_0__.AppService.emit(_enums_events_enum_js__WEBPACK_IMPORTED_MODULE_2__.Events.PostTask, task);\n    };\n    this.fetchTask = function (data) {\n      console.log(\"maindata\", data.status);\n      var taskID = parseInt(data.taskID);\n      console.log('data', data.data, JSON.stringify(data.data));\n      var response = JSON.stringify(data.data);\n      var statusStr = data.status;\n      var status = Object.values(_enums_TaskStatuses_enum_js__WEBPACK_IMPORTED_MODULE_1__.TaskStatuses).find(function (status) {\n        return status === statusStr;\n      });\n      console.log(taskID);\n      var task = _this.getTaskByID(taskID);\n      if (task) {\n        task.setStatus(status);\n        task.setResponse(response);\n      }\n      _app_service_js__WEBPACK_IMPORTED_MODULE_0__.AppService.emit(_enums_events_enum_js__WEBPACK_IMPORTED_MODULE_2__.Events.PostTask, task);\n    };\n    this.createTask = function (config) {\n      var newID = _this.generateTaskID();\n      while (_this.getTaskByID(newID)) {\n        newID = _this.generateTaskID();\n      }\n      var task = new _Task_js__WEBPACK_IMPORTED_MODULE_3__.Task(newID, config);\n      _this.taskPool.push(task);\n      return task;\n    };\n    this.generateTaskID = function () {\n      var max = 99999;\n      var min = 10000;\n      return Math.floor(Math.random() * (max - min) + min);\n    };\n    this.getTaskByID = function (id) {\n      var task = null;\n      _this.taskPool.forEach(function (currentTask) {\n        if (currentTask.getID() === id) {\n          task = currentTask;\n        }\n      });\n      return task;\n    };\n  }\n  return TasksService;\n}();\n\n\n//# sourceURL=webpack://zonk/./build/tasks/tasks.service.js?");
